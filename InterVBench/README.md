...
**Execute the script from the directory `InterVBench`.** The command below processes every `.mp4` in the chosen input folder and writes one JSON file per metric into the output directory.
