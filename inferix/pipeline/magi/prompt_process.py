...
from inferix.core.utils import env_is_true
from inferix.models.magi.logger import magi_logger
from inferix.distributed.dist_utils import is_last_tp_cp_rank
from inferix.distributed import parallel_state as mpu
from inferix.models.magi.t5 import T5Embedder

# Use environment variable or default path for special token file
SPECIAL_TOKEN_PATH = os.getenv("SPECIAL_TOKEN_PATH", "example/magi/assets/special_tokens.npz")
...
def get_negative_special_token_keys() -> List[str] | None:
