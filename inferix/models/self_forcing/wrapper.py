...
from inferix.models.self_forcing.model import WanModel, RegisterTokens, GanAttentionBlock
...
class WanDiffusionWrapper(torch.nn.Module):
    ...
    def forward(
        ...
        timestep: torch.Tensor, kv_cache_meta: Optional[List[dict]] = None,
        crossattn_cache_meta: Optional[List[dict]] = None,
        ...
        if kv_cache_meta is not None:
            flow_pred = self.model(
                ...
                crossattn_cache_meta=crossattn_cache_meta,
