...
from inferix.core.config import EngineConfig, ModelConfig
from inferix.core.types.inference import InferenceParams, ModelMetaArgs, PackedCrossAttnParams
from inferix.core.utils import divide
from inferix.distributed import parallel_state
from inferix.distributed.parallelism import CSOHelper, UlyssesScheduler, cso_communication
from inferix.kvcache_manager.model.magi_kv_cache_manager import MagiKVCacheManager
...
class FullyParallelAttention(Attention):
    def __init__(self, model_config: ModelConfig, engine_config: EngineConfig, layer_number: int):
        ...
        self.kv_cache_manager = MagiKVCacheManager(
    ...
    def _full_adjust_key_and_value(
        ...
        """
        return self.kv_cache_manager._full_adjust_key_and_value(inference_params, key_and_value, meta_args) 
    ...
    def adjust_key_and_value_for_inference(
        ...
        return self.kv_cache_manager.adjust_key_and_value_for_inference(key_and_value, inference_params, meta_args)
