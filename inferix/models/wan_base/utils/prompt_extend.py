...
if __name__ == "__main__":
    ...
    qwen_model_name = os.getenv("QWEN_MODEL_PATH", "./models/Qwen2.5-14B-Instruct/")  # VRAM: 29136MiB
    # qwen_model_name = os.getenv("QWEN_MODEL_PATH", "./models/Qwen2.5-14B-Instruct-AWQ/")  # VRAM: 10414MiB
    ...
    # qwen_model_name = os.getenv("QWEN_VL_MODEL_PATH", "./models/Qwen2.5-VL-3B-Instruct/") #VRAM: 9686MiB
    qwen_model_name = os.getenv("QWEN_VL_MODEL_PATH", "./models/Qwen2.5-VL-7B-Instruct-AWQ/")  # VRAM: 8492
    image = os.getenv("EXAMPLE_IMAGE_PATH", "./examples/i2v_input.JPG")
